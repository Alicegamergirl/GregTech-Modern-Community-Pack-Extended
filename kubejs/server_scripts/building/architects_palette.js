ServerEvents.recipes((event) => {
  ...
  event.recipes.gtceu
    .mixer('abyssaline')
    .itemInputs('gtceu:obsidian_dust', 'prismarine_shard')
  ...
  event.recipes.gtceu
    .mixer('myonite')
    .itemInputs('stone', '#forge:mushrooms')
  ...
  event.recipes.gtceu
    ...
    .itemInputs('stone', '#forge:dyes/green')
  ...
  event.recipes.gtceu
    ...
    .itemInputs('#architects_palette:olivestone', 'glowstone')
  ...
  event.recipes.gtceu
    ...
    .itemInputs('architects_palette:algal_bricks', 'kelp')
  ...
  event.recipes.gtceu
    .mixer('algal_lamp')
    .itemInputs('architects_palette:algal_brick', 'glowstone')
  ...
  event.recipes.gtceu
    ...
    .itemInputs('architects_palette:osseous_skull', 'torch')
  ...
  event.recipes.gtceu
    ...
    .itemInputs('sandstone', 'gold_nugget')
  ...
  event.recipes.gtceu
    ...
    .itemInputs('blackstone', 'weeping_vines')
  ...
  event.recipes.gtceu
    ...
    .itemInputs('blackstone', 'twisting_vines')
  ...
  event.recipes.gtceu
    ...
    .itemInputs('end_stone_bricks', 'chorus_fruit')
  ...
  event.recipes.gtceu
    .mixer('sunstone')
    .itemInputs('basalt', 'architects_palette:sunmetal_blend')
  ...
  event.recipes.gtceu
    ...
    .itemInputs('nether_bricks', 'magma_block')
  ...
  event.recipes.gtceu
    .mixer('oracle_lamp')
    .itemInputs('architects_palette:oracle_jelly', 'end_rod')
  ...
  getWarped('#logs', 'architects_palette:twisted_log')
  getWarped('#planks', 'architects_palette:twisted_planks')
  getWarped('#saplings', 'architects_palette:twisted_sapling')
  getWarped('#leaves', 'architects_palette:twisted_leaves')
