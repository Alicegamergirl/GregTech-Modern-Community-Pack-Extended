ServerEvents.recipes((event) => {
  ...
  event.remove({ id: 'blaze_powder' });
  event.remove({ id: 'gtceu:shapeless/blaze_rod_to_powder' });
  event.remove({ id: 'ender_eye' });
  ...
  greg
    ...
    .itemInputs('prismarine_crystals')
  ...
  event.shaped(Item.of('enchanted_book').enchant('silk_touch', 1), ['RWR', 'WBW', 'RmR'], {
